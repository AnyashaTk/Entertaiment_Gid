...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSubmit(View v) {
        ...
        int myRadioChecked;
        if (radioGroup.getCheckedRadioButtonId() == findViewById(R.id.radioButton2).getId() && button.isEnabled()) {
        ...
        } else if (radioGroup.getCheckedRadioButtonId() == findViewById(R.id.radioButton1).getId() && button.isEnabled()) {
            ...
            intent.setData(Uri.parse("geo:50.080345, 14.428974"));
            ...
            intent3.setData(Uri.parse("geo:52.518621, 13.375142"));
            ...
            intent4.setData(Uri.parse("geo:51.507351, -0.127696"));
